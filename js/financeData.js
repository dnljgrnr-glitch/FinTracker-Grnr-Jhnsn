window.FINANCE_DATA = {
  ...
  daniel: {
    ...
    debts: [
      { name: "NFCU Visa",         balance: 9315.95,  apr: 17.5, minimum: 452.82, targetPayment: 700  },
      { name: "NFCU Vehicle Loan", balance: 22010.21, apr: 9.14, minimum: 426.20                      },
      { name: "Apple Card",        balance: 930.39,   apr: 20,   minimum: 50                          }
    ],
    savings: [
      { name: "Move Fund",       balance: 0,    goal: 1950 },
      { name: "Emergency Fund",  balance: 0,    goal: 5000 }
    ],
    spendCaps: [
      { name: "Gas / Transport", cap: 175 },
      { name: "Food & Personal", cap: 150 },
      { name: "Fast Food",       cap: 60  },
      { name: "Online Shopping", cap: 50  }
    ],
    checklist: [
    ...
    budget: [
      ["Shared household expenses", "$768"],
      ["Vehicle loan",              "$426.20"],
      ["Visa minimum",              "$452.82"],
      ["Extra Visa target",         "$247.18"],
      ["Progressive",               "$134"],
      ["Verizon target",            "$120"],
      ["TruStage",                  "$12.50"],
      ["Apple Card",                "$50"],
      ["Claude + Netflix",          "$30.73"],
      ["Gas / transportation",      "$175"],
      ["Personal / food / misc",    "$150"],
  ...
  sonia: {
    ...
    debts: [
      { name: "Northwest Bank Loan", balance: 2266.02, apr: 12.50, minimum: 135.83 },
      { name: "Family Debt",         balance: 10000,   apr: 0,     minimum: 200    },
      { name: "Apple Card",          balance: 0,       apr: 20,    minimum: 20     }
    ],
    savings: [
      { name: "Apple / Emergency",  balance: 900,  goal: 2500 },
      { name: "Sinking Fund",       balance: 0,    goal: 1000 }
    ],
    spendCaps: [
      { name: "Beauty / Personal",  cap: 100 },
      { name: "Fast Food",          cap: 60  },
      { name: "Amazon / Online",    cap: 50  },
      { name: "Apple Cash",         cap: 50  }
    ],
    checklist: [
  ...
  household: {
    ...
    debtSequence: [
      ...
      [4, "Sonia Northwest loan",                "$2,266.02 at 12.50%; extra after savings target" ],
